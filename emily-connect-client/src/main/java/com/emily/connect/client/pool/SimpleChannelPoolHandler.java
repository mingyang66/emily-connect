package com.emily.connect.client.pool;

import com.emily.connect.client.handler.HeartBeatChannelHandler;
import com.emily.connect.client.handler.IoChannelHandler;
...
public class SimpleChannelPoolHandler extends AbstractChannelPoolHandler {
     ...
     */
    public static final Map<ChannelId, IoChannelHandler> IO_HANDLER_MAP = PlatformDependent.newConcurrentHashMap();
    ...
    public void channelCreated(Channel ch) throws Exception {
        ...
        IO_HANDLER_MAP.put(ch.id(), new IoChannelHandler());
